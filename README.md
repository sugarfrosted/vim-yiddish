...
Apple's terminal does not appear compatible with right to left characters. For a replacement I recommend iTerm2. Either the current beta or the original release.
